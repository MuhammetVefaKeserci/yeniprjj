...
public class CommentService {
    ...
    public Comment updateOneCommentById(Long commentId, CommentUpdateDto request) {
        ...
        if (comment.isPresent()){
            ...
            commentToUpdate.setText(request.getText()); //textini request den gelen text ile değiştirelim
            return commentRepository.save(commentToUpdate); //ve update edilmiş son halini repomuza kaydedelim
        }else
            return null;
    }
